#' integralBayes
#'
#' Produces a plot with shading under the curve
#'
#' @param meanval value of the mean
#' @param sdval value of the standard deviation
#'
#' @return a plot with appropriate shading with labels
#' @export
#'
#' @importFrom openStuff openGraph
#' @importFrom graphics lines text
#'
#' @examples \dontrun{integralBayes(0.0, 0.2)}
